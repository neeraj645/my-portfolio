    ...
    <section className="min-h-[85vh] flex flex-col justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto w-full">
        ...
        <p className="text-base sm:text-lg text-zinc-600 dark:text-zinc-400 mb-12 max-w-2xl leading-relaxed">
          I architect scalable backend infrastructures using <span className="text-zinc-900 dark:text-zinc-100 font-semibold">Go</span>, <span className="text-zinc-900 dark:text-zinc-100 font-semibold">Java</span>, and <span className="text-zinc-900 dark:text-zinc-100 font-semibold">Kubernetes</span>. 
